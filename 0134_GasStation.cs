...
namespace LeetCode
{
    ...
    */
    ...
    {
        // You can take advantage of the guarantee that there is only 1 unique solution.

        // Calculate the difference between the gas and cost indexes. As long as there is
        // an index where the difference is positive, that will be the solution.
